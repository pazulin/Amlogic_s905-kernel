...
static struct vinfo_s tv_info[] = {
	...
	},
	{
		...
		.sync_duration_num = 60,
		.sync_duration_den = 1,
		.screen_real_width = 17,
		.screen_real_height = 10,
		.video_clk         = 50400000,
		.viu_color_fmt     = TVIN_YUV444,
	},
	{
	...
	},
	{
		...
		.sync_duration_num = 60,
		.sync_duration_den = 1,
		.screen_real_width = 59,
		.screen_real_height = 60,
		.video_clk         = 185580000,
		.viu_color_fmt     = TVIN_YUV444,
	},
	{
		...
		.sync_duration_num = 60,
		.sync_duration_den = 1,
		.screen_real_width = 43,
		.screen_real_height = 18,
		.video_clk         = 319750000,
		.viu_color_fmt     = TVIN_YUV444,
	},
	{
		.name              = "480x320p60hz",
		.mode              = TVMODE_480x320p60hz,
		.width             = 480,
		.height            = 320,
		.field_height      = 320,
		.aspect_ratio_num  = 3,
